...
from solo_spdxdebian.commons.utils import bash, md5, log_minimal_error
from solo_spdxdebian.commons.archive import Archive

from solo_spdxdebian.commons.pool import Pool
from solo_spdxdebian.commons.settings import Settings
...
if __name__ == '__main__':
    ...
    debsrc_orig = "./ffmpeg_4.1.6.orig.tar.xz"
    debsrc_debian = "./ffmpeg_4.1.6-1_deb10u1.debian.tar.xz"
    d2s = Debian2SPDX(debsrc_orig, debsrc_debian)
    d2s.generate_SPDX()
    d2s.write_SPDX("./ffmpeg_4.1.6.spdx")